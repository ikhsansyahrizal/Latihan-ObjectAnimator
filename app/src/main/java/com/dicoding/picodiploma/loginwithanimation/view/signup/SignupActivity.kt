...
class SignupActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val signp = ObjectAnimator.ofFloat(binding.signupButton, View.ALPHA, 1f).setDuration(1000)


        AnimatorSet().apply {
            playSequentially(title, nameTv, nameEt, emailTv, emailEt, passTv, passEt, signp)
            start()
        }
