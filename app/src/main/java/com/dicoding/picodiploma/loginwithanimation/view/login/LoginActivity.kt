...
class LoginActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val messageTV = ObjectAnimator.ofFloat(binding.messageTextView, View.ALPHA, 1f).setDuration(1000)
        ...
        val signp = ObjectAnimator.ofFloat(binding.loginButton, View.ALPHA, 1f).setDuration(1000)


        AnimatorSet().apply {
            playSequentially(title, messageTV, emailTv, emailEt, passTv, passEt, signp)
            start()
        }
